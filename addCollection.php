...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Collect input for collection creation
    ...
    $result = $collection->createCollection($name, $description, $conn);
    ...
    if ($result === true) {
        ...
        echo "Failed to create collection: " . $result;
    }
}
?>
        ...
        <div class="create-profile-container">
            <div class="px-4 py-5 my-5">
                ...
                <h2 class="display-5 fw-bold text-body-emphasis text-center">
                    Add <span class="blue">New </span><span class="orange">Collection</span>
                </h2>
                <p class="mt-3 mb-3 text-center">
                    Please enter information to create a new collection.
                </p>
